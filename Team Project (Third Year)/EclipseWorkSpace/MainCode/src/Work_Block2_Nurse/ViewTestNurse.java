...
import Work_Block2_Doctor.Tests;


public class ViewTestNurse extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewTestNurse frame = new ViewTestNurse();
	...
	public ViewTestNurse() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int searchTestNo=0;
				searchTestNo = Integer.parseInt(textField.getText());
				Tests SearchTest = Tests.getTest(searchTestNo);
				if(searchTestNo != SearchTest.getpatientID())
				{
					...
					model.setRowCount(0);
					model.addRow(new Object[]{SearchTest.getID(),SearchTest.getTestType(),
							SearchTest.getResults(), SearchTest.getTestDate(),SearchTest.getDoc()
					});
				}
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DiagnosisMenuNurse().setVisible(true);
				dispose();
			}
		});
