...
import Work_Block2_Doctor.Diagnosis;


public class ViewDiagnosisNurse extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewDiagnosisNurse frame = new ViewDiagnosisNurse();
