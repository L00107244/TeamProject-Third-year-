...
import Work_Block2_Doctor.ViewPatient;
...
public class NurseMenu extends JFrame {
	...
	public NurseMenu() {
		...
		JLabel lblNewLabel3 = new JLabel("Logged in As ");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_3.setBounds(10, 372, 100, 18);
		panel.add(lblNewLabel_3);
		...
		JLabel lblNewLabel_5 = new JLabel("Welcome to the Nurse Menu");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new ViewTreatmentNurse().setVisible(true);
				dispose();
			}
		});
		...
		JLabel lblNewLabel_7 = new JLabel("Nurse Options");
		lblNewLabel_7.setForeground(Color.BLACK);
		lblNewLabel_7.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_7.setBounds(10, 25, 89, 36);
