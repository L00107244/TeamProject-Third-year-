...
import Work_Block2_Doctor.Treatment;


public class ViewTreatmentNurse extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewTreatmentNurse frame = new ViewTreatmentNurse();
	...
	public ViewTreatmentNurse() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int searchTreatNo=0;
				searchTreatNo = Integer.parseInt(textField.getText());
				Treatment SearchTreat = Treatment.getTreatment(searchTreatNo);
				if(searchTreatNo != SearchTreat.getpatientID())
				{
					...
					model.setRowCount(0);
					model.addRow(new Object[]{SearchTreat.getID(),SearchTreat.gettreatmenttype(),
							SearchTreat.getdosage(), SearchTreat.gettreatmentname(),SearchTreat.getlengthOfStay(),SearchTreat.geteffects()
							,SearchTreat.getbeginDate() ,SearchTreat.getEndDate(),SearchTreat.getNotes(),SearchTreat.getDoc()
					});
				}
			}
