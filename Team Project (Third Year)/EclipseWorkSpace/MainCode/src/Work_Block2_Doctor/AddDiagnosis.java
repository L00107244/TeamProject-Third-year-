	...
	public AddDiagnosis() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String compliants = ComField_2.getText();

				String diagnosisb = DiaField_5.getText();
				String symptonsb = sympField_6.getText();
				...
				for(Patient p: arp){
					...
					{
						Diagnosis addDiagnosis = new Diagnosis(searchHostpital,compliants,symptonsb , diagnosisb,date, seenby);
						int addStatus = Diagnosis.add(addDiagnosis);
						if(addStatus==1) 
						{
