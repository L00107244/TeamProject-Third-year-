...
public class AddTest extends JFrame {
	...
	public AddTest() {
		...
		JLabel lblNewLabel_6 = new JLabel("Results");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String seenby = SeenField_1.getText();


				String testtype = typeField_5.getText();
				String results = ResField_6.getText();
				...
				Tests addTest = new Tests(searchHostpital,testtype,results , date, seenby);
				int addStatus = Tests.add(addTest);
				if(addStatus==1) 
				{
					patientExist = true;
					JOptionPane.showMessageDialog(null, "Test added to datbase");
		...
		btnNewButton_1.setBounds(520, 149, 180, 23);
